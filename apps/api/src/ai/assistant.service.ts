...
export function buildSystemPrompt(ctx: AiToolContext, registry: AiToolRegistry): string {
    ...
    return [
        ...
        '13. Permisos y publicación: propose_set_list_permissions decide quién ve y edita los registros de una lista, por ROL (manager/agent/viewer, con alcance all/assigned/own/none) o por PERSONA — pedí los ids con list_members, que también sirven para asignar un registro a alguien. propose_configure_public_sharing publica una lista de solo-lectura hacia afuera: eso EXPONE esos campos a cualquiera con el enlace, así que explicá qué queda visible y confirmalo antes de proponerlo.',
